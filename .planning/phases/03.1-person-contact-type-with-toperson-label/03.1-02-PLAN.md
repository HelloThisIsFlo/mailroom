...
**Step 4: Update upsert_contact call signature in _process_sender:**
...
- The CardDAV client's `upsert_contact` already accepts and forwards `contact_type` to `create_contact` (done in Plan 01 Step 3)
